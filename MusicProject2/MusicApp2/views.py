...
''''''
#from MusicProject2.MusicApp.models import *
''''''
...
class AlbumDetail(DetailView):
    model = Album
    template_name = "MusicApp2/templates/MusicApp/album_detail.html"
...
class TrackDetail(DetailView):
    model = Track
    template_name = "MusicApp2/templates/MusicApp/track_detail.html"
...
class AlbumCreate(CreateView):
    ...
    def get_initial(self):
        ...
        initial['artist'] = Artist.objects.get(id=self.kwargs['pk'])
        return initial
...
class TrackCreate(CreateView):
    ...
    def get_initial(self):
        initial = super(TrackCreate, self).get_initial()
        initial['album'] = Album.objects.get(id=self.kwargs['pk'])
        return initial
